...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    ...
    - XSS attacks (Content-Security-Policy; stricter sandbox for reports)
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        # Old reports may contain unescaped feed or model text. Apply an opaque,
        # script-free sandbox even to reports generated by older versions.
        if request.url.path.startswith("/artifacts/report/"):
            response.headers["Content-Security-Policy"] = (
